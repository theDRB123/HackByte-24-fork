...
const Home_retailers_comp = () => {
  return (
    ...
    <div className='bg-[#f8d5d1]  h-[500px] flex flex-col justify-center items-center gap-7'>
            <div className='text-[50px] text-center'>Start contributing NOW!</div>
            <div className='text-center'>Worried about your privacy? contribute anonymously to the datasets and earn rewards after each download.</div>
